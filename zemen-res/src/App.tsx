              ...
              <div id="top" className="font-serif text-gray-900">
                  ...
                  >
                    ...
                    <div className="bg-black bg-opacity-60 p-10 rounded">
                      <h1 className="text-4xl md:text-5xl font-bold mb-4">
                        Welcome to Zemen Bar and Restaurant
                      </h1>
                ...
                <footer className="bg-black text-white text-center py-6">
                  ...
                  <p className="text-sm mt-2">
                    <a href="https://www.google.com/maps?q=2148+E+Belt+Line+Rd,+Richardson,+TX+75081-3930" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-500">
